...
const passawordStyles = 'w-full relative min-h-[70px]';
const eyeStyles = 'absolute w-[50px] grid place-items-center h-[55px] text-[var(--primary)] absolute right-0';
...
const LoginPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (!isGmailValid || !isPasswordValid || !isAccept || !userCredential.name) {
      ...
      const isExisting = await authServices.getUserData();
    ...
    <div className="signup-form">
      ...
      <div className="main-body">
        <div className="flex flex-col overflow-auto w-full">
          <p className="text-[1.7rem] font-semibold mb-[20px]">Create Your Account</p>
          ...
          <div className={passawordStyles}>
            <input type={showPassword ? "text" : "password"}
              ...
              onChange={handleText}
            />
            <div className={eyeStyles} onClick={handleShowPassword}>
